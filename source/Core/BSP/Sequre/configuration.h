...
#define TIP_PWM_SLOWDOWN_MAX_C    55 // Highest value the user may set; the derate (55 C) and the die cut-out still apply
#define TIP_PWM_SLOWDOWN_SETTING  1  // Expose the threshold in the power menu
